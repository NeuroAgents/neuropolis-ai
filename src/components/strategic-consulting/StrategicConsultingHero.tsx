...
export default function StrategicConsultingHero() {
  ...
  return (
    <motion.section
      ...
      initial="hidden"
      animate="show"
      className="relative flex items-center justify-center overflow-hidden pt-[120px] sm:pt-[150px] md:pt-[180px] lg:pt-[200px] pb-16 md:pb-24 bg-gradient-to-b from-white to-gray-50 dark:from-gray-950 dark:to-gray-900"
    >
      {/* Фоновые элементы */}
      ...
      <motion.div
        ...
        initial="initial"
        animate="animate"
        className="absolute bottom-[15%] left-[10%] w-24 h-24 bg-blue-400/20 dark:bg-blue-600/30 rounded-full backdrop-blur-md z-0"
      ...
      <motion.div
        ...
        initial="initial"
        animate="animate"
        className="absolute top-[30%] left-[25%] w-32 h-32 rounded-full bg-gradient-to-tr from-blue-500/5 to-indigo-500/5 backdrop-blur-lg z-0"
      ></motion.div>
      <motion.div
        variants={pulseVariants}
        initial="initial"
        ...
        className="absolute bottom-[25%] right-[15%] w-40 h-40 rounded-full bg-gradient-to-bl from-blue-500/5 to-indigo-500/5 backdrop-blur-lg z-0"
      ></motion.div>
      ...
      <div className="relative z-20 text-center max-w-[90%] sm:max-w-[85%] md:max-w-[80%] lg:max-w-[900px] mx-auto px-4">
        ...
        >
          ...
          для трансформации вашего бизнеса
        </motion.h1>
        ...
        >
          Разрабатываем комплексные стратегии внедрения искусственного
          интеллекта и цифровой трансформации, адаптированные под уникальные
          потребности вашего бизнеса, с экспертным сопровождением на всех
          этапах.
        </motion.p>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            href="#cta"
            className="inline-block w-full sm:w-auto bg-gradient-to-r from-[#0167F3] to-[#399AFC] text-white font-semibold py-4 px-8 rounded-xl text-lg md:text-xl transition-all hover:shadow-lg hover:shadow-blue-500/20 dark:hover:shadow-blue-600/20"
          >
          ...
          <motion.a
            ...
            className="inline-block w-full sm:w-auto bg-transparent border-2 border-[#0167F3] text-[#0167F3] dark:text-blue-400 font-semibold py-4 px-8 rounded-xl text-lg md:text-xl transition-all hover:bg-blue-50 dark:hover:bg-blue-900/20"
          >
            Узнать больше
          </motion.a>
        </motion.div>
        ...
        >
          <div className="flex items-center space-x-1.5">
            <svg
              className="w-5 h-5 text-[#0167F3] dark:text-blue-400 flex-shrink-0"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
              <path
